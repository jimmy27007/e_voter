...
validate_registration_details(register_first_name, register_second_name, register_id_number, register_age, register_county, male_gender, female_gender, other_gender, selected_country, register_telephone, register_email, register_password, register_confirm_password, register_sum_result, registration_send_code, register_verification_code, submit_registration_form, uploaded_img_name);
display_flags(selected_country); // document.addEventListener('DOMContentLoaded',()=>{
